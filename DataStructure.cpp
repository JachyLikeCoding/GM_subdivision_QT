...
Vec3f Vertex::calVertexPoint(){
	...
	if (m != n) {
		qDebug() << "Wrong! Edge count is " << n << ", Face count is " << m << endl;
	}
...
Face:
*/
void Face::addEdge(Vertex &v1, Vertex &v2, QQueue<Edge *> &equeue) 
{
...
void Face::addVertex(Vertex *&v, QQueue<Vertex*>& vqueue)
{
