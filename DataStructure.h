...
public:
	...
	void addEdge(Vertex &v1, Vertex &v2, QQueue<Edge *> &equeue);
	void addVertex(Vertex *&v, QQueue<Vertex *> &vqueue);

	//triangle face
	Face(Vertex *&v1, Vertex *&v2, Vertex *&v3, QQueue<Edge *> &equeue, QQueue<Vertex *> &vqueue, int _level = 0) {
		level = _level;
	...
	//quad face
	Face(Vertex *&v1, Vertex *&v2, Vertex *&v3, Vertex *&v4, QQueue<Edge *> &equeue, QQueue<Vertex *> &vqueue, int _level = 0) {
		level = _level;
	...
	void faceDisplay();
	void printfCenterV() {
		qDebug() << "fCenterV: " << fCenterv.x << ", " << fCenterv.y << ", " << fCenterv.z << endl;
	}
